  ...
  return (
    <div>
      <h2 id="account-transaction-heading" data-cy="AccountTransactionHeading">
        <Translate contentKey="blockchainApplicationApp.accountTransaction.home.title">Account Transactions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="blockchainApplicationApp.accountTransaction.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="blockchainApplicationApp.accountTransaction.home.createLabel">Create new Account Transaction</Translate>
          </Link>
        </div>
      </h2>
        ...
        {accountTransactionList && accountTransactionList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="blockchainApplicationApp.accountTransaction.id">ID</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="blockchainApplicationApp.accountTransaction.home.notFound">No Account Transactions found</Translate>
            </div>
          )
        )}
      </div>
