...
/**
 * REST controller for managing {@link com.isoft.blockchain.domain.ClientAccount}.
 */
@RestController
...
public class ClientAccountResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<ClientAccountDTO> createClientAccount(@RequestBody ClientAccountDTO clientAccountDTO) throws URISyntaxException {
    ...
    public ResponseEntity<ClientAccountDTO> updateClientAccount(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, clientAccountDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ClientAccountDTO> partialUpdateClientAccount(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, clientAccountDTO.getId())
        );
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<ClientAccountDTO> getClientAccount(@PathVariable("id") String id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteClientAccount(@PathVariable("id") String id) {
